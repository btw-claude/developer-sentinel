...
| Execution result | Per-attempt completion with status and response summary | `INFO executor: Agent execution SUCCESS for PROJ-123 (attempt 2/3): <response_summary>` |
