...
def _deprecation_warning(old_name: str, new_name: str) -> None:
    """Emit a deprecation warning for backward compatibility properties.

    Args:
        old_name: The deprecated property name (e.g., "config.jira_base_url").
...
class Config:
    ...
    def poll_interval(self) -> int:
        ...
        .. deprecated::
            Use ``config.polling.interval`` instead.
        """
        _deprecation_warning("config.poll_interval", "config.polling.interval")
    ...
    def max_issues_per_poll(self) -> int:
        ...
        .. deprecated::
            Use ``config.polling.max_issues_per_poll`` instead.
        """
        _deprecation_warning("config.max_issues_per_poll", "config.polling.max_issues_per_poll")
    ...
    def log_level(self) -> str:
        ...
        .. deprecated::
            Use ``config.logging_config.level`` instead.
        """
        _deprecation_warning("config.log_level", "config.logging_config.level")
    ...
    def log_json(self) -> bool:
        ...
        .. deprecated::
            Use ``config.logging_config.json`` instead.
        """
        _deprecation_warning("config.log_json", "config.logging_config.json")
    ...
    def max_concurrent_executions(self) -> int:
        ...
        .. deprecated::
            Use ``config.execution.max_concurrent_executions`` instead.
        """
    ...
    def orchestrations_dir(self) -> Path:
        ...
        .. deprecated::
            Use ``config.execution.orchestrations_dir`` instead.
        """
        _deprecation_warning("config.orchestrations_dir", "config.execution.orchestrations_dir")
    ...
    def agent_workdir(self) -> Path:
        ...
        .. deprecated::
            Use ``config.execution.agent_workdir`` instead.
        """
        _deprecation_warning("config.agent_workdir", "config.execution.agent_workdir")
    ...
    def agent_logs_dir(self) -> Path:
        ...
        .. deprecated::
            Use ``config.execution.agent_logs_dir`` instead.
        """
        _deprecation_warning("config.agent_logs_dir", "config.execution.agent_logs_dir")
    ...
    def orchestration_logs_dir(self) -> Path | None:
        ...
        .. deprecated::
            Use ``config.execution.orchestration_logs_dir`` instead.
        """
        _deprecation_warning(
    ...
    def cleanup_workdir_on_success(self) -> bool:
        ...
        .. deprecated::
            Use ``config.execution.cleanup_workdir_on_success`` instead.
        """
        _deprecation_warning(
    ...
    def disable_streaming_logs(self) -> bool:
        ...
        .. deprecated::
            Use ``config.execution.disable_streaming_logs`` instead.
        """
        _deprecation_warning(
    ...
    def subprocess_timeout(self) -> float:
        ...
        .. deprecated::
            Use ``config.execution.subprocess_timeout`` instead.
        """
        _deprecation_warning("config.subprocess_timeout", "config.execution.subprocess_timeout")
    ...
    def default_base_branch(self) -> str:
        ...
        .. deprecated::
            Use ``config.execution.default_base_branch`` instead.
        """
        _deprecation_warning("config.default_base_branch", "config.execution.default_base_branch")
    ...
    def attempt_counts_ttl(self) -> int:
        ...
        .. deprecated::
            Use ``config.execution.attempt_counts_ttl`` instead.
        """
        _deprecation_warning("config.attempt_counts_ttl", "config.execution.attempt_counts_ttl")
    ...
    def max_queue_size(self) -> int:
        ...
        .. deprecated::
            Use ``config.execution.max_queue_size`` instead.
        """
        _deprecation_warning("config.max_queue_size", "config.execution.max_queue_size")
    ...
    def inter_message_times_threshold(self) -> int:
        ...
        .. deprecated::
            Use ``config.execution.inter_message_times_threshold`` instead.
        """
        _deprecation_warning(
            "config.inter_message_times_threshold",
            "config.execution.inter_message_times_threshold",
        )
    ...
    def shutdown_timeout_seconds(self) -> float:
        ...
        .. deprecated::
            Use ``config.execution.shutdown_timeout_seconds`` instead.
        """
        _deprecation_warning(
    ...
    def jira_base_url(self) -> str:
        ...
        .. deprecated::
            Use ``config.jira.base_url`` instead.
        """
        _deprecation_warning("config.jira_base_url", "config.jira.base_url")
    ...
    def jira_email(self) -> str:
        ...
        .. deprecated::
            Use ``config.jira.email`` instead.
        """
        _deprecation_warning("config.jira_email", "config.jira.email")
    ...
    def jira_api_token(self) -> str:
        ...
        .. deprecated::
            Use ``config.jira.api_token`` instead.
        """
        _deprecation_warning("config.jira_api_token", "config.jira.api_token")
    ...
    def jira_epic_link_field(self) -> str:
        ...
        .. deprecated::
            Use ``config.jira.epic_link_field`` instead.
        """
        _deprecation_warning("config.jira_epic_link_field", "config.jira.epic_link_field")
    ...
    def jira_configured(self) -> bool:
        ...
        .. deprecated::
            Use ``config.jira.configured`` instead.
        """
        _deprecation_warning("config.jira_configured", "config.jira.configured")
    ...
    def github_token(self) -> str:
        ...
        .. deprecated::
            Use ``config.github.token`` instead.
        """
        _deprecation_warning("config.github_token", "config.github.token")
    ...
    def github_api_url(self) -> str:
        ...
        .. deprecated::
            Use ``config.github.api_url`` instead.
        """
        _deprecation_warning("config.github_api_url", "config.github.api_url")
    ...
    def github_configured(self) -> bool:
        ...
        .. deprecated::
            Use ``config.github.configured`` instead.
        """
        _deprecation_warning("config.github_configured", "config.github.configured")
    ...
    def dashboard_enabled(self) -> bool:
        ...
        .. deprecated::
            Use ``config.dashboard.enabled`` instead.
        """
        _deprecation_warning("config.dashboard_enabled", "config.dashboard.enabled")
    ...
    def dashboard_port(self) -> int:
        ...
        .. deprecated::
            Use ``config.dashboard.port`` instead.
        """
        _deprecation_warning("config.dashboard_port", "config.dashboard.port")
    ...
    def dashboard_host(self) -> str:
        ...
        .. deprecated::
            Use ``config.dashboard.host`` instead.
        """
        _deprecation_warning("config.dashboard_host", "config.dashboard.host")
    ...
    def toggle_cooldown_seconds(self) -> float:
        ...
        .. deprecated::
            Use ``config.dashboard.toggle_cooldown_seconds`` instead.
        """
        _deprecation_warning(
    ...
    def rate_limit_cache_ttl(self) -> int:
        ...
        .. deprecated::
            Use ``config.dashboard.rate_limit_cache_ttl`` instead.
        """
        _deprecation_warning(
    ...
    def rate_limit_cache_maxsize(self) -> int:
        ...
        .. deprecated::
            Use ``config.dashboard.rate_limit_cache_maxsize`` instead.
        """
        _deprecation_warning(
    ...
    def max_recent_executions(self) -> int:
        ...
        .. deprecated::
            Use ``config.dashboard.max_recent_executions`` instead.
        """
        _deprecation_warning(
    ...
    def claude_rate_limit_enabled(self) -> bool:
        ...
        .. deprecated::
            Use ``config.rate_limit.enabled`` instead.
        """
        _deprecation_warning("config.claude_rate_limit_enabled", "config.rate_limit.enabled")
    ...
    def claude_rate_limit_per_minute(self) -> int:
        ...
        .. deprecated::
            Use ``config.rate_limit.per_minute`` instead.
        """
        _deprecation_warning("config.claude_rate_limit_per_minute", "config.rate_limit.per_minute")
    ...
    def claude_rate_limit_per_hour(self) -> int:
        ...
        .. deprecated::
            Use ``config.rate_limit.per_hour`` instead.
        """
        _deprecation_warning("config.claude_rate_limit_per_hour", "config.rate_limit.per_hour")
    ...
    def claude_rate_limit_strategy(self) -> str:
        ...
        .. deprecated::
            Use ``config.rate_limit.strategy`` instead.
        """
        _deprecation_warning("config.claude_rate_limit_strategy", "config.rate_limit.strategy")
    ...
    def claude_rate_limit_warning_threshold(self) -> float:
        ...
        .. deprecated::
            Use ``config.rate_limit.warning_threshold`` instead.
        """
        _deprecation_warning(
    ...
    def claude_rate_limit_max_queued(self) -> int:
        ...
        .. deprecated::
            Use ``config.rate_limit.max_queued`` instead.
        """
        _deprecation_warning("config.claude_rate_limit_max_queued", "config.rate_limit.max_queued")
    ...
    def claude_rate_limit_queue_full_strategy(self) -> str:
        ...
        .. deprecated::
            Use ``config.rate_limit.queue_full_strategy`` instead.
        """
        _deprecation_warning(
    ...
    def circuit_breaker_enabled(self) -> bool:
        ...
        .. deprecated::
            Use ``config.circuit_breaker.enabled`` instead.
        """
        _deprecation_warning("config.circuit_breaker_enabled", "config.circuit_breaker.enabled")
    ...
    def circuit_breaker_failure_threshold(self) -> int:
        ...
        .. deprecated::
            Use ``config.circuit_breaker.failure_threshold`` instead.
        """
        _deprecation_warning(
    ...
    def circuit_breaker_recovery_timeout(self) -> float:
        ...
        .. deprecated::
            Use ``config.circuit_breaker.recovery_timeout`` instead.
        """
        _deprecation_warning(
    ...
    def circuit_breaker_half_open_max_calls(self) -> int:
        ...
        .. deprecated::
            Use ``config.circuit_breaker.half_open_max_calls`` instead.
        """
        _deprecation_warning(
    ...
    def health_check_enabled(self) -> bool:
        ...
        .. deprecated::
            Use ``config.health_check.enabled`` instead.
        """
        _deprecation_warning("config.health_check_enabled", "config.health_check.enabled")
    ...
    def health_check_timeout(self) -> float:
        ...
        .. deprecated::
            Use ``config.health_check.timeout`` instead.
        """
        _deprecation_warning("config.health_check_timeout", "config.health_check.timeout")
    ...
    def default_agent_type(self) -> str:
        ...
        .. deprecated::
            Use ``config.cursor.default_agent_type`` instead.
        """
        _deprecation_warning("config.default_agent_type", "config.cursor.default_agent_type")
    ...
    def cursor_path(self) -> str:
        ...
        .. deprecated::
            Use ``config.cursor.path`` instead.
        """
        _deprecation_warning("config.cursor_path", "config.cursor.path")
    ...
    def cursor_default_model(self) -> str:
        ...
        .. deprecated::
            Use ``config.cursor.default_model`` instead.
        """
        _deprecation_warning("config.cursor_default_model", "config.cursor.default_model")
    ...
    def cursor_default_mode(self) -> str:
        ...
        .. deprecated::
            Use ``config.cursor.default_mode`` instead.
        """
        _deprecation_warning("config.cursor_default_mode", "config.cursor.default_mode")
