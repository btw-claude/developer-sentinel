...
def make_config(
    ...
    Constructs a Config with sub-config objects, providing convenient defaults
    ...
    Args:
        ...
        attempt_counts_ttl: TTL in seconds for retry attempt tracking.
        max_queue_size: Maximum queued issues.
        cleanup_workdir_on_success: Remove workdir after success.
        disable_streaming_logs: Disable real-time log writes.
        subprocess_timeout: Default subprocess timeout in seconds.
        ...
        toggle_cooldown_seconds: Cooldown between file toggle writes.
    ...
    Returns:
        A Config instance with the specified parameters organized into
        sub-configs.
